...
<jsp:include page="/WEB-INF/common/website_header.jsp"/>
 ...
 <div class="content">
  <div class="width1190">
   <div class="reg-logo">
 <h4>用户注册</h4>
   <form id="signupForm" method="post" action="LoginServlet?action=registe1" class="zcform">
  <span  style="color:red">${msg }</span>
        ...
        <p class="clearfix">
          ...
          <p class="clearfix">
        	...
        	<input id="nickname" name="nickname" type="text" class="required" placeholder="请输入您的昵称" />
    ...
    <div class="reg-logo-right">
     <h3>如果您已有账号，请</h3>
     <a href="UserServlet?action=toUserLogin" class="logo-a">立即登录</a>
    </div><!--reg-logo-right/-->
    <div class="clears"></div>
  </div>
  </div>
